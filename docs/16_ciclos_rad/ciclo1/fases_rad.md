...
#### Versão Desktop
![Protótipo da Página Inicial – Computador](../../00_assets/imagens/prototipagem/pagina_inicial/computador_v1.png){ width="40%" style="display: block; margin: 0 auto;" }

#### Versão Mobile
![Protótipo da Página Inicial – Celular](../../00_assets/imagens/prototipagem/pagina_inicial/celular_v1.png){ width="100" style="display: block; margin: 0 auto;" }
...
##### Versão Desktop
![Site Real - Página Inicial Computador](../../00_assets/imagens/pagina/pagina_inicial/computador_parte1.png){ width="50%" style="display: block; margin: 0 auto;" }
![Site Real - Página Inicial Computador](../../00_assets/imagens/pagina/pagina_inicial/computador_parte2.png){ width="50%" style="display: block; margin: 0 auto;" }

##### Versão Mobile
![Site Real - Página Inicial Celular](../../00_assets/imagens/pagina/pagina_inicial/celular_parte1.png){ width="150" style="display: block; margin: 0 auto;" }
![Site Real - Página Inicial Celular](../../00_assets/imagens/pagina/pagina_inicial/celular_parte2.png){ width="150" style="display: block; margin: 0 auto;" }
...
**Link para análise técnica:** [Repositório de Transição - Ciclo 1](https://github.com/mdsreq-fga-unb/REQ-2026.1-T01-PortalEntreAmigos/tree/develop)
