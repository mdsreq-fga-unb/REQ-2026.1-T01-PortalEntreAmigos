...
*   *Mapeamento visual no Figma:* [Protótipos de Alta Fidelidade do Ciclo 1](../../16_ciclos_rad/ciclo1/fases_rad.md#design-do-usuario)
...
*   **Critérios de Aceitação:** Verificação das informações institucionais, contatos e layout responsivo. Evidências disponíveis em [Critérios de Aceitação - Ciclo 1](../../16_ciclos_rad/ciclo1/criterios_evidencias.md).
*   **DoR (Definition of Ready) e DoD (Definition of Done):** Totalmente revisados e marcados como concluídos. Evidências disponíveis em [DoR e DoD - Ciclo 1](../../16_ciclos_rad/ciclo1/dor_dod_evidencias.md).
